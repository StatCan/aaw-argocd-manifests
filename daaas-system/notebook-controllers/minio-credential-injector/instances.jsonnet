...
local instances = if std.extVar('targetRevision') == "aaw-prod-cc-00" then
{
    ...
    {"name": "minio_gateway_standard", "classification": "unclassified", "serviceUrl": "http://minio-gateway.minio-gateway-standard-system:9000", "externalUrl": "https://minio-gateway-standard-system-boathouse.aaw.cloud.statcan.ca"}
    {"name": "minio_gateway_premium", "classification": "unclassified", "serviceUrl": "http://minio-gateway.minio-gateway-premium-system:9000", "externalUrl": "https://minio-gateway-premium-system-boathouse.aaw.cloud.statcan.ca"}
