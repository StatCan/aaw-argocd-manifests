...
local instances = if std.extVar('targetRevision') == "aaw-prod-cc-00" then
{
    ...
    {"name": "minio_gateway_standard", "alias": "", "classification": "unclassified", "serviceUrl": "http://minio-gateway.minio-gateway-standard-ro-system:9000", "externalUrl": "https://minio-gateway-standard-ro-system-boathouse.aaw.cloud.statcan.ca"}
    {"name": "minio_gateway_premium", "alias": "", "classification": "unclassified", "serviceUrl": "http://minio-gateway.minio-gateway-premium-ro-system:9000", "externalUrl": "https://minio-gateway-premium-ro-system-boathouse.aaw.cloud.statcan.ca"}
